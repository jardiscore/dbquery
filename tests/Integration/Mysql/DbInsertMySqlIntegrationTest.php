...
/**
 * MySQL Integration Tests for DbInsert
 *
 * Tests actual INSERT query execution against MySQL database
 */
class DbInsertMySqlIntegrationTest extends TestCase
{
    ...
    // REMOVED: MySQL DbInsert doesn't support ignore() method
    // Use onDuplicateKeyUpdate() instead for MySQL
    /*

...
/**
 * MariaDB Integration Tests for DbUpdate
 *
 * Tests actual UPDATE query execution against MariaDB database
 */
class DbUpdateMariaDbIntegrationTest extends TestCase
{
